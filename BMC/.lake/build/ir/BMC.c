...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_bmc_BMC_NullRun(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
